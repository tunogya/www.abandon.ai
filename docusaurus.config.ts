...
const config: Config = {
  ...
  organizationName: 'tunogya', // Usually your GitHub org/user name.
  projectName: 'www.abandon.ai', // Usually your repo name.
    ...
    [
      'classic',
      {
        ...
        docs: {
          ...
          editUrl:
            'https://github.com/tunogya/www.abandon.ai/tree/main',
        },
        blog: {
